...
const SHAPE_vtable TESTSHAPE_vtable = {&TESTSHAPE_local_intersect,    &SHAPE_delete,        &TESTSHAPE_local_normal_at,
                                       &SHAPE_default_shape_contains, &TESTSHAPE_bounds_of, NULL};
