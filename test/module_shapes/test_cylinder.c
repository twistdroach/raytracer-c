...
void helper_intersect_constrained_cylinder(double px, double py, double pz,
                                           double dx, double dy, double dz,
                                           unsigned int count) {
    CYLINDER_Cylinder* c = CYLINDER_new();
    c->maximum = 2;
...
void helper_intersect_caps_of_closed_cylinder(double px, double py, double pz,
                                              double dx, double dy, double dz,
                                              unsigned int count) {
    CYLINDER_Cylinder* c = CYLINDER_new();
    c->minimum = 1;
...
void helper_test_normal_vector_on_cylinder_end_caps(double px, double py, double pz,
                                                    double nx, double ny, double nz) {
    CYLINDER_Cylinder* c = CYLINDER_new();
    c->minimum = 1;
    c->maximum = 2;
