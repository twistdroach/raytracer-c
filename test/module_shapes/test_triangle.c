...
void test_ray_misses_p1_p3_edge() { helper_ray_misses_triangle(1, 1, -2); }

void test_ray_misses_p1_p2_edge() { helper_ray_misses_triangle(-1, 1, -2); }

void test_ray_misses_p2_p3_edge() { helper_ray_misses_triangle(0, -1, -2); }
