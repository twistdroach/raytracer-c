...
void helper_intersecting_cone_with_ray(double ox, double oy, double oz,
...
void helper_intersect_cone_end_cap(double px, double py, double pz,
                                   double dx, double dy, double dz,
                                   unsigned int count) {
...
void helper_compute_normal_on_cone(double px, double py, double pz,
