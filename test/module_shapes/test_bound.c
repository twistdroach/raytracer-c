...
void check_box_in_box(double minx, double miny, double minz, double maxx, double maxy, double maxz, bool expected_result) {
  BOUND_Box box1;
  BOUND_init(&box1);
  BOUND_add_point(&box1, -5, -2, 0);
...
void check_ray_bound_box_intersection_with_box(BOUND_Box *box, double ox, double oy, double oz, double dx, double dy, double dz, bool expected_result) {
...
void check_ray_bound_box_intersection(double ox, double oy, double oz, double dx, double dy, double dz, bool expected_result) {
  BOUND_Box box;
  BOUND_init(&box);
  BOUND_add_point(&box, -1, -1, -1);
  BOUND_add_point(&box, 1, 1, 1);
...
void check_ray_non_cube_bound_box_intersection(double ox, double oy, double oz, double dx, double dy, double dz, bool expected_result) {
  BOUND_Box box;
  BOUND_init(&box);
  BOUND_add_point(&box, 5, -2, 0);
  BOUND_add_point(&box, 11, 4, 7);
